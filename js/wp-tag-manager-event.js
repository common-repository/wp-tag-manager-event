window.addEventListener('unload', function() {
  ...
  if( window.google_tag_manager == true ) {
    gtag(
      ...
      'event_label': 'l\'utente ha raggiunto la seguente percentuale di pagina: ' + jQuery("meta[name='wp_tag_scroll']").attr("content"),
      'value': 1
    });
  }

  if( window.google_tag_manager == false && window.analitycs == true ) {
    ga('send', 'event', 'scroll max', 'scroll', 'l\'utente ha raggiunto la seguente percentuale di pagina: ' + jQuery("meta[name='wp_tag_scroll']").attr("content"), 1);
  }
